---
title: "Mapping biodiversity from space: spatio-temporal spectral metrics for geographical intelligence"
...
![](../images/structure_berlin.png){fig-align="center"}
...
<https://github.com/ducciorocchini/cellulaR>
...
Rocchini, D. (2026). Ecosystem shuffle: the `neutRal` R package to simulate species dance moves. Community Ecology. doi: <https://doi.org/10.1007/s42974-026-00310-8>
...
<https://github.com/ducciorocchini/cblindplot>

## Theoretical result

::: {style="text-align: center;"}
![](../images/alien_daltonic.png){align="center" width="80%"}
:::

[\@ NASA SBG](https://science.nasa.gov/earth-science/decadal-surveys/decadal-sbg/)

## Empirical result

::: {style="text-align: center;"}
![](../images/rasterdiv_strict_highres2.png){align="center" width="50%"}
:::
...
## Remote sensing in Ecology from scratch

::: {style="text-align: center;"}
![](../images/ecolinf_imageRy.png){align="center" fig-align="center" width="100%"}
:::
